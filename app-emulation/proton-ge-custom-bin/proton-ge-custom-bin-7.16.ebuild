...
SRC_URI="https://github.com/GloriousEggroll/proton-ge-custom/releases/download/GE-Proton7-16/GE-Proton7-16.tar.gz -> ${PN}-${PV}.tar.gz"
_internal_name=GE-Proton7-16
...
QA_PREBUILT="*"
S="${WORKDIR}"
PATCHES=("${FILESDIR}/proton-ge-custom-bin-7.16-create-dosdevices.patch")
