...
SRC_URI="https://github.com/GloriousEggroll/proton-ge-custom/releases/download/GE-Proton7-8/GE-Proton7-8.tar.gz -> ${P}.tar.gz"
...
QA_PREBUILT="*"
S="${WORKDIR}"
PATCHES=("${FILESDIR}/proton-ge-custom-bin-7.8-create-dosdevices.patch")
