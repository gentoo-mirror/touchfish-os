...
SRC_URI="https://github.com/GloriousEggroll/proton-ge-custom/releases/download/GE-Proton7-20/GE-Proton7-20.tar.gz -> ${P}.tar.gz"
_internal_name=GE-Proton7-20
...
QA_PREBUILT="*"
S="${WORKDIR}"
PATCHES=("${FILESDIR}/proton-ge-custom-bin-7.20-create-dosdevices.patch")
